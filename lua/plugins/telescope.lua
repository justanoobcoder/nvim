return {
  ...
  keys = {
    ...
    { "<leader>sw", require("util.telescope").telescope("grep_string", { word_match = "-w" }), desc = "Word (root dir)" },
    { "<leader>sW", require("util.telescope").telescope("grep_string", { cwd = false, word_match = "-w" }), desc = "Word (cwd)" },
